...
class FindAddressActivity : AppCompatActivity() {
    ...
    private val TAG: String = FindAddressActivity::class.java.simpleName
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mapView.apply {
            ...
            onTouchListener = object : DefaultMapViewOnTouchListener(this@FindAddressActivity, mapView) {
                    ...
                    if (newText.isNotEmpty()){
                        ...
                        suggestionsFuture.addDoneListener{
                            try {
                                ...
                                val suggestionAdapter = SimpleCursorAdapter(this@FindAddressActivity,
